export const PATHS = {
  ...
  apmWorkOrders: '/app/asset-performance/work-orders',
  apmCostRoi: '/app/asset-performance/cost-roi',
  apmReliability: '/app/asset-performance/reliability',
  apmAssetExplorer: '/app/asset-performance/asset-explorer',
  apmCriticalAssets: '/app/asset-performance/critical-assets',
  oee: '/app/oee',
